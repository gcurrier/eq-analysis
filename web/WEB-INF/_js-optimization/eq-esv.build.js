...
({
  ...
  // mainConfigFile: '../webapp/WEB-INF/resources/js/main.js',
  ...
  paths: {
    ...
    'text': 'lib/requirejs/plugin/text-2.0.15',
    // the left side is the module ID, the right side is the path to the jQuery file, relative to baseUrl. Also, the path should NOT include the '.js' file extension.
    'jquery': 'lib/jquery/jquery-3.2.1.min',
    'jquery.loadTemplate': 'lib/jquery/plugin/jquery.loadTemplate-1.5.10.min',
    'jquery.uriAnchor': 'lib/jquery/plugin/jquery.uriAnchor-1.3.5',
    'jquery.blockUI': 'lib/jquery/plugin/jquery.blockUI',
    'jquery.jgrowl': 'lib/jquery/plugin/jquery.jgrowl.min',
    'jquery.fileupload': 'lib/jquery/plugin/jquery.fileupload',

    'jquery.ui': 'lib/jquery-ui-1.12.1/jquery-ui.min',

    'log4javascript': 'lib/log4javascript/log4javascript-1.4.13.min',

    'sockjs': 'lib/sockjs/sockjs-1.1.1.min',
    'webstomp': 'lib/webstomp/webstomp-1.0.4.min',

    //dev config
    'taffydb': 'dev/lib/taffydb/taffy-2.7.3.min',

    //module core
    'proxied_ag-grid-12.0.2': 'module/core/lib/ag-grid-12.0.2/ag-grid-enterprise.min',
    'ag-grid@nglc': 'module/core/lib/foo'
  },
  ...
  shim: {
    'jquery': {},
    'jquery.loadTemplate': {deps: ['jquery']},
    'jquery.uriAnchor': {deps: ['jquery']},
    ...
    //module dev config
    'taffydb': {exports: 'TAFFY'},

    //module core
    'ag-grid@nglc': {
      deps: ['proxied_ag-grid-12.0.2'],
      init: function (ag) {
        //apply the license and return
        ag.LicenseManager.setLicenseKey('Medizinisch_Genetisches_Zentrum_Site_2Devs9_January_2018__MTUxNTQ1NjAwMDAwMA==9f8cec505a32dc267d9bcc1ca7680845');
        return ag;
      }
    }
  },
  ...
  modules: [
    ...
    // //just develop/d.ebug one or two modules at a time.
    // {
    //   name: "foo/bar/bin",
    //   excludeShallow: [
    //     "foo/bar/bot"
    ...
    //the shell module
    {
      ...
      include: [
        "RJSOnResourceLoad",
        "jquery",
        "common/LoggingWrapper",
        "controller/Shell",
        "controller/Fallback",
        "controller/Module",
        "controller/ApiInvocation",
        "log4javascript",
        "jquery.uriAnchor",
        "jquery.ui",
        "jquery.loadTemplate",
    ...
    //the core module
    {
      name: "module/ngl-core",
      include: [
        "module/core/controller/Home",
        "module/core/controller/Actor",
        "module/core/controller/Role",
        "module/core/controller/Group",
        "module/core/controller/Session"
      ],
      exclude: [
        "common/LoggingWrapper",
        "jquery",
    ...
    // the dev module
    {
      name: "dev/devConfig",
      include: ["dev/MockDb"],
      exclude: ["common/LoggingWrapper", "module/module.dev"]
    }
  ],
